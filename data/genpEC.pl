...
# 2015-03-28: from scratch
#
# usage:
#   perl genpEC.pl exp left right
#-----------------------------------
use strict;
     ...
     *  Caution: This Java method was generated on $timestamp by ramath/data/genpEC.pl.
...
sub forblock {
    ...
    for ($iex = 1; $iex <= $exp1; $iex ++) {
        ...
        print "${indent}int m$iex${col}p$exp =          m$iex$col";
        for (my $ie2 = 1; $ie2 < $exp; $ie2 ++) {
            print "*m$iex$col";
        } # for $ie2
        print ";\n";
    } # for $iex
