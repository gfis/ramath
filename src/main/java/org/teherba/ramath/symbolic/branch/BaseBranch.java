...
public class BaseBranch {
    ...
    */
    ...
    //----
    /** a {@link Dispenser} to be used for the expansion */
    private Dispenser meter;
    /** Sets the     {@link Dispenser} to be used for the expansion
     *  @param meter {@link Dispenser} to be used for the expansion
     */
    public void setDispenser(Dispenser meter) {
        this.meter = meter;
    } // setDispenser
    /** Gets the {@link Dispenser} to be used for the expansion
     *  @return  {@link Dispenser} to be used for the expansion
     */
     ...
     */
    private void prepare(RelationSet rset1) {
    } // prepare
     ...
     *  Pseudo-abstract, will be refined by derived classes.
