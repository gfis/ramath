...
Expanding for base=3, level=1, reasons+features=base,transpose,primitive,same,similiar 
...
[0+3a,1+3b,0+3c,1+3d]:	transposed [2] by [2,0,1,3]
[0+3a,0+3b,1+3c,1+3d]:	transposed [2] by [2,1,0,3]
[2+3a,1+3b,1+3c,1+3d]:	unknown -> [3] [2,1,1,1] 36a+54a²+27a³+9b+27b²+27b³+9c+27c²+27c³-9d-27d²-27d³+9
[1+3a,2+3b,1+3c,1+3d]:	transposed [3] by [2,0,1,3]
[1+3a,1+3b,2+3c,1+3d]:	transposed [3] by [2,1,0,3]
[2+3a,0+3b,0+3c,2+3d]:	unknown -> [4] [2,0,0,2] 36a+54a²+27a³+27b³+27c³-36d-54d²-27d³
-> solution [2,0,0,2],trivial(3) [5,0,0,5],trivial(3)
[0+3a,2+3b,0+3c,2+3d]:	transposed [4] by [2,0,1,3]
[2+3a,2+3b,1+3c,2+3d]:	unknown -> [5] [2,2,1,2] 36a+54a²+27a³+36b+54b²+27b³+9c+27c²+27c³-36d-54d²-27d³+9
[0+3a,0+3b,2+3c,2+3d]:	transposed [4] by [2,1,0,3]
[2+3a,1+3b,2+3c,2+3d]:	transposed [5] by [1,2,0,3]
[1+3a,2+3b,2+3c,2+3d]:	transposed [5] by [2,0,1,3]
endexp[0]
---------------- level 1
Maximum level 1 [6] mod 3: a³+b³+c³-d³
