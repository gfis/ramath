/*  Generated at yyyy-mm-dd hh:mm by
    java -cp dist/ramath.jar org.teherba.ramath.ProgramGenerator  -w 3 -l 6 -v "[a^2+b^2,a^4-6*a^2*b^2+b^4,4*a^3*b-4*a*b^3]" -v "[5,7,24]" -n -p "p^4 = q^2 + r^2" m2opts
...
[[6,1,-1],[6,-1,4],[6,6,2]]	preserves	[13,119,120]
  261  1322 11794 test/PG14.this.tst
