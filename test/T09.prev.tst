...
expanding queue[2]: 16*x^2 + 16*y^2 - 128*x*y*z + 16*z^2 = 0 modulo [1,1,1] *8
[0+4*x,0+4*y,0+4*z]: similiar to  [2], same  16*x^2+16*y^2-128*x*y*z+16*z^2=0 success [0,0,0],trivial(3) 
