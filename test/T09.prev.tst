...
expanding queue[1]^0: 4*x^2 + 4*y^2 - 16*x*y*z + 4*z^2 = 0 meter=[2,2,2] *4
...
expanding queue[2]^1: 16*x^2 + 16*y^2 - 128*x*y*z + 16*z^2 = 0 meter=[2,2,2] *8
...
expanding queue[3]^2: 64*x^2 + 64*y^2 - 1024*x*y*z + 64*z^2 = 0 meter=[2,2,2] *16
...
expanding queue[4]^3: 256*x^2 + 256*y^2 - 8192*x*y*z + 256*z^2 = 0 meter=[2,2,2] *32
...
expanding queue[5]^4: 1024*x^2 + 1024*y^2 - 65536*x*y*z + 1024*z^2 = 0 meter=[2,2,2] *64
...
expanding queue[6]^5: 4096*x^2 + 4096*y^2 - 524288*x*y*z + 4096*z^2 = 0 meter=[2,2,2] *128
...
expanding queue[7]^6: 16384*x^2 + 16384*y^2 - 4194304*x*y*z + 16384*z^2 = 0 meter=[2,2,2] *256
...
expanding queue[8]^7: 65536*x^2 + 65536*y^2 - 33554432*x*y*z + 65536*z^2 = 0 meter=[2,2,2] *512
