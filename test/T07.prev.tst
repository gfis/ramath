...
[3+4*a,1+4*b,0+2*c]: grown from [1] 28+108*a+144*a^2+64*a^3+12*b+48*b^2+64*b^3-8*c^3=0
[1+4*a,3+4*b,0+2*c]: grown from [1] 28+12*a+48*a^2+64*a^3+108*b+144*b^2+64*b^3-8*c^3=0
[3+4*a,3+4*b,0+2*c]: failure constant=54, vgcd=4

expanding queue[2]: 6*a + 12*a^2 + 8*a^3 + 8*b^3 - 6*c - 12*c^2 - 8*c^3 = 0 modulo [2,1,2] *4
[1+4*a,0+2*b,1+4*c]: grown from [2] 12*a+48*a^2+64*a^3+8*b^3-12*c-48*c^2-64*c^3=0 success [1,0,1],trivial(3) success [5,0,5],trivial(3) 
