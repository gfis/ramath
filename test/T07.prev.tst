...
[1+4*a,0+2*b,1+4*c]: grown from [0] 12*a+48*a^2+64*a^3+8*b^3-12*c-48*c^2-64*c^3=0 success [1,0,1],trivial(3) success [5,0,5],trivial(3) 
...
[7+16*a,1+16*b,2+8*c]: grown from [0] 336+2352*a+5376*a^2+4096*a^3+48*b+768*b^2+4096*b^3-96*c-384*c^2-512*c^3=0
...
[3+16*a,5+16*b,2+8*c]: grown from [0] 144+432*a+2304*a^2+4096*a^3+1200*b+3840*b^2+4096*b^3-96*c-384*c^2-512*c^3=0
