...
[0+128x,0+128y,0+128z]:	unknown -> [7] [0,0,0] x²+y²-256N*x*y*z+z²
-> solution [0,0,0],trivial(3)
[64+128x,0+128y,0+128z]:	failure constant=1, vgcd=4 [1,0,0] 4x+4x²+4y²-512N*y*z-1024N*x*y*z+4z²+1
[0+128x,64+128y,0+128z]:	failure constant=1, vgcd=4 [0,1,0] 4x²+4y+4y²-512N*x*z-1024N*x*y*z+4z²+1
[64+128x,64+128y,0+128z]:	failure constant=1, vgcd=2 [1,1,0] 2x+2x²+2y+2y²-128N*z-256N*x*z-256N*y*z-512N*x*y*z+2z²+1
[0+128x,0+128y,64+128z]:	failure constant=1, vgcd=4 [0,0,1] 4x²-512N*x*y+4y²+4z-1024N*x*y*z+4z²+1
[64+128x,0+128y,64+128z]:	failure constant=1, vgcd=2 [1,0,1] 2x+2x²-128N*y-256N*x*y+2y²+2z-256N*y*z-512N*x*y*z+2z²+1
[0+128x,64+128y,64+128z]:	failure constant=-1, vgcd=2 [0,1,1] 128N*x-2x²-2y+256N*x*y-2y²-2z+256N*x*z+512N*x*y*z-2z²-1
[64+128x,64+128y,64+128z]:	failure constant=-3, vgcd=4 [1,1,1] 128N-4x+256N*x-4x²-4y+256N*y+512N*x*y-4y²-4z+256N*z+512N*x*z+512N*y*z+1024N*x*y*z-4z²-3
