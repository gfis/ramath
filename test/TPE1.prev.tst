...
----------------
expanding queue[0]^-1,meter=[2,2]*2: 15x²-7y²-9
...
----------------
expanding queue[1]^0,meter=[2,2]*4: 15x²-7y-7y²-2
...
----------------
expanding queue[2]^1,meter=[1,2]*8: 30x²-7y-14y²-1
[0+12x,3+24y]:	failure constant=-1, vgcd=2
[0+12x,15+24y]:	unknown -> [3] 15x²-35y-28y²-11
----------------
expanding queue[3]^2,meter=[2,2]*16: 15x²-35y-28y²-11
