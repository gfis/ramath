...
[0+2*x,0+2*y]: similiar to  [0], affine map: {x=(2*x),y=(2*y)}  4-8*x^3+4*y^2=0 success [2,2],trivial(2) 
...
[1+4*x,1+4*y]: similiar to  [1], affine map: {x=(2*x),y=(2*y)}  4-12*x-48*x^2-64*x^3+8*y+16*y^2=0
...
[5+16*x,3+16*y]: similiar to  [3], affine map: {x=(2*x),y=(2*y)}  -112-1200*x-3840*x^2-4096*x^3+96*y+256*y^2=0
...
[13+32*x,7+32*y]: similiar to  [5], affine map: {x=(2*x),y=(2*y)}  -2144-16224*x-39936*x^2-32768*x^3+448*y+1024*y^2=0
...
[13+64*x,23+64*y]: similiar to  [7], affine map: {x=(2*x),y=(2*y)}  -1664-32448*x-159744*x^2-262144*x^3+2944*y+4096*y^2=0
...
[29+64*x,31+64*y]: similiar to  [9], affine map: {x=(2*x),y=(2*y)}  -23424-161472*x-356352*x^2-262144*x^3+3968*y+4096*y^2=0
