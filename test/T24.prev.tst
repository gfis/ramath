...
[0+2*x,0+2*y]: unknown 4-8*x^3+4*y^2=0 -> [1]
...
[1+4*x,1+4*y]: unknown 4-12*x-48*x^2-64*x^3+8*y+16*y^2=0 -> [4]
[1+4*x,3+4*y]: unknown 12-12*x-48*x^2-64*x^3+24*y+16*y^2=0 -> [5]
----------------
...
[2+8*x,2+8*y]: unknown -96*x-384*x^2-512*x^3+32*y+64*y^2=0 -> [11]
...
[5+16*x,5+16*y]: unknown -96-1200*x-3840*x^2-4096*x^3+160*y+256*y^2=0 -> [15]
[5+16*x,13+16*y]: unknown 48-1200*x-3840*x^2-4096*x^3+416*y+256*y^2=0 -> [16]
expanding queue[9]^5:  - 112 - 600*x - 960*x^2 - 512*x^3 + 48*y + 64*y^2 = 0 meter=[2,2] *16
[5+16*x,3+16*y]: unknown -112-1200*x-3840*x^2-4096*x^3+96*y+256*y^2=0 -> [17]
...
solution [2,2],trivial(2)
[2+16*x,2+16*y]: unknown -192*x-1536*x^2-4096*x^3+64*y+256*y^2=0 -> [21]
...
[13+32*x,9+32*y]: unknown -2112-16224*x-39936*x^2-32768*x^3+576*y+1024*y^2=0 -> [27]
...
[5+32*x,5+32*y]: unknown -96-2400*x-15360*x^2-32768*x^3+320*y+1024*y^2=0 -> [29]
[5+32*x,21+32*y]: unknown 320-2400*x-15360*x^2-32768*x^3+1344*y+1024*y^2=0 -> [30]
...
[5+32*x,11+32*y]: unknown -2400*x-15360*x^2-32768*x^3+704*y+1024*y^2=0 -> [35]
[5+32*x,27+32*y]: unknown 608-2400*x-15360*x^2-32768*x^3+1728*y+1024*y^2=0 -> [36]
expanding queue[19]^10:  - 2144 - 8112*x - 9984*x^2 - 4096*x^3 + 224*y + 256*y^2 = 0 meter=[2,2] *32
[13+32*x,7+32*y]: unknown -2144-16224*x-39936*x^2-32768*x^3+448*y+1024*y^2=0 -> [37]
...
solution [2,2],trivial(2)
[2+32*x,2+32*y]: unknown -384*x-6144*x^2-32768*x^3+128*y+1024*y^2=0 -> [41]
...
[10+32*x,10+32*y]: unknown -896-9600*x-30720*x^2-32768*x^3+640*y+1024*y^2=0 -> [43]
...
[2+32*x,30+32*y]: unknown 896-384*x-6144*x^2-32768*x^3+1920*y+1024*y^2=0 -> [48]
expanding queue[25]^13:  - 24384 - 80736*x - 89088*x^2 - 32768*x^3 + 64*y + 1024*y^2 = 0 meter=[2,2] *64
[29+64*x,1+64*y]: unknown -24384-161472*x-356352*x^2-262144*x^3+128*y+4096*y^2=0 -> [49]
...
[13+64*x,9+64*y]: unknown -2112-32448*x-159744*x^2-262144*x^3+1152*y+4096*y^2=0 -> [53]
...
[5+64*x,21+64*y]: unknown 320-4800*x-61440*x^2-262144*x^3+2688*y+4096*y^2=0 -> [59]
[5+64*x,53+64*y]: unknown 2688-4800*x-61440*x^2-262144*x^3+6784*y+4096*y^2=0 -> [60]
expanding queue[31]^16:  - 9088 - 42336*x - 64512*x^2 - 32768*x^3 + 832*y + 1024*y^2 = 0 meter=[2,2] *64
[21+64*x,13+64*y]: unknown -9088-84672*x-258048*x^2-262144*x^3+1664*y+4096*y^2=0 -> [61]
...
[21+64*x,19+64*y]: unknown -8896-84672*x-258048*x^2-262144*x^3+2432*y+4096*y^2=0 -> [67]
...
solution [5,11],NONTRIVIAL
[5+64*x,11+64*y]: unknown -4800*x-61440*x^2-262144*x^3+1408*y+4096*y^2=0 -> [69]
[5+64*x,43+64*y]: unknown 1728-4800*x-61440*x^2-262144*x^3+5504*y+4096*y^2=0 -> [70]
...
[13+64*x,23+64*y]: unknown -1664-32448*x-159744*x^2-262144*x^3+2944*y+4096*y^2=0 -> [75]
[13+64*x,55+64*y]: unknown 832-32448*x-159744*x^2-262144*x^3+7040*y+4096*y^2=0 -> [76]
...
[29+64*x,31+64*y]: unknown -23424-161472*x-356352*x^2-262144*x^3+3968*y+4096*y^2=0 -> [79]
