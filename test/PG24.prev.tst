/*  Generated at yyyy-mm-dd hh:mm by
    java -cp dist/ramath.jar org.teherba.ramath.ProgramGenerator  -w 3 -l 4 -v "[a^2+b^2,a^4-6*a^2*b^2+b^4,4*a^3*b-4*a*b^3]" -v "[13,119,120]" -n -p "p^4 = q^2 + r^2" m2opts
...
#---- start of results ----
 165  966 6412 test/PG24.this.tst
