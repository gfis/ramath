...
[1+4*a,1+4*b,0+2*c]: failure, grown from [1]
...
[3+8*a,0+4*b,3+8*c]: failure, grown from [5]
...
[0+4*a,3+8*b,1+8*c]: failure, grown from [6]
...
[0+4*a,1+8*b,3+8*c]: failure, grown from [7]
