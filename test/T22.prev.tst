...
[0+3*a,0+3*b,0+3*c]: same form as 27*a^3+27*b^3-27*c^3=0
...
[1+9*a,0+3*b,1+9*c]: similiar to  [2], affine map: {a=(3*a),b=(1*b),c=(3*c)}  27*a+243*a^2+729*a^3+27*b^3-27*c-243*c^2-729*c^3=0
...
[4+9*a,0+3*b,4+9*c]: success [4,0,4],trivial(3) success [13,0,13],trivial(3)  432*a+972*a^2+729*a^3+27*b^3-432*c-972*c^2-729*c^3=0 -> [7]
...
[7+9*a,0+3*b,7+9*c]: success [7,0,7],trivial(3) success [16,0,16],trivial(3)  1323*a+1701*a^2+729*a^3+27*b^3-1323*c-1701*c^2-729*c^3=0 -> [8]

expanding queue[3]: 36*a + 54*a^2 + 27*a^3 + 27*b^3 - 36*c - 54*c^2 - 27*c^3 = 0 modulo [3,1,3] *9
[2+9*a,0+3*b,2+9*c]: similiar to  [3], affine map: {a=(3*a),b=(1*b),c=(3*c)}  108*a+486*a^2+729*a^3+27*b^3-108*c-486*c^2-729*c^3=0
...
[5+9*a,0+3*b,5+9*c]: success [5,0,5],trivial(3) success [14,0,14],trivial(3)  675*a+1215*a^2+729*a^3+27*b^3-675*c-1215*c^2-729*c^3=0 -> [9]
...
[8+9*a,0+3*b,8+9*c]: success [8,0,8],trivial(3) success [17,0,17],trivial(3)  1728*a+1944*a^2+729*a^3+27*b^3-1728*c-1944*c^2-729*c^3=0 -> [10]
...
[4+27*a,0+9*b,4+27*c]: similiar to  [7], affine map: {a=(3*a),b=(3*b),c=(3*c)}  1296*a+8748*a^2+19683*a^3+729*b^3-1296*c-8748*c^2-19683*c^3=0
...
[13+27*a,0+9*b,13+27*c]: success [13,0,13],trivial(3) success [40,0,40],trivial(3)  13689*a+28431*a^2+19683*a^3+729*b^3-13689*c-28431*c^2-19683*c^3=0 -> [40]
...
[22+27*a,0+9*b,22+27*c]: success [22,0,22],trivial(3) success [49,0,49],trivial(3)  39204*a+48114*a^2+19683*a^3+729*b^3-39204*c-48114*c^2-19683*c^3=0 -> [43]
...
[7+27*a,0+9*b,7+27*c]: similiar to  [8], affine map: {a=(3*a),b=(3*b),c=(3*c)}  3969*a+15309*a^2+19683*a^3+729*b^3-3969*c-15309*c^2-19683*c^3=0
...
[16+27*a,0+9*b,16+27*c]: success [16,0,16],trivial(3) success [43,0,43],trivial(3)  20736*a+34992*a^2+19683*a^3+729*b^3-20736*c-34992*c^2-19683*c^3=0 -> [48]
...
[25+27*a,0+9*b,25+27*c]: success [25,0,25],trivial(3) success [52,0,52],trivial(3)  50625*a+54675*a^2+19683*a^3+729*b^3-50625*c-54675*c^2-19683*c^3=0 -> [51]
...
[5+27*a,0+9*b,5+27*c]: similiar to  [9], affine map: {a=(3*a),b=(3*b),c=(3*c)}  2025*a+10935*a^2+19683*a^3+729*b^3-2025*c-10935*c^2-19683*c^3=0
...
[14+27*a,0+9*b,14+27*c]: success [14,0,14],trivial(3) success [41,0,41],trivial(3)  15876*a+30618*a^2+19683*a^3+729*b^3-15876*c-30618*c^2-19683*c^3=0 -> [56]
...
[23+27*a,0+9*b,23+27*c]: success [23,0,23],trivial(3) success [50,0,50],trivial(3)  42849*a+50301*a^2+19683*a^3+729*b^3-42849*c-50301*c^2-19683*c^3=0 -> [59]
...
[8+27*a,0+9*b,8+27*c]: similiar to  [10], affine map: {a=(3*a),b=(3*b),c=(3*c)}  5184*a+17496*a^2+19683*a^3+729*b^3-5184*c-17496*c^2-19683*c^3=0
...
[17+27*a,0+9*b,17+27*c]: success [17,0,17],trivial(3) success [44,0,44],trivial(3)  23409*a+37179*a^2+19683*a^3+729*b^3-23409*c-37179*c^2-19683*c^3=0 -> [64]
...
[26+27*a,0+9*b,26+27*c]: success [26,0,26],trivial(3) success [53,0,53],trivial(3)  54756*a+56862*a^2+19683*a^3+729*b^3-54756*c-56862*c^2-19683*c^3=0 -> [67]
