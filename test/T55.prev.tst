...
[0,1,1,0]:	transposed [2] {a=>1+2*a,b=>2*b,c=>1+2*c,d=>2*d} by [1,0,2,3]
[1,0,0,1]:	transposed [2] {a=>1+2*a,b=>2*b,c=>1+2*c,d=>2*d} by [0,1,3,2]
[0,1,0,1]:	transposed [2] {a=>1+2*a,b=>2*b,c=>1+2*c,d=>2*d} by [1,0,3,2]
...
[0,2,0,0]:	transposed [5] {a=>2+4*a,b=>4*b,c=>4*c,d=>4*d} by [1,0,2,3]
...
[0,4,0,0]:	transposed [11] {a=>4+8*a,b=>8*b,c=>8*c,d=>8*d} by [1,0,2,3]
...
[2,0,0,4]:	transposed [13] {a=>2+8*a,b=>8*b,c=>4+8*c,d=>8*d} by [0,1,3,2]
[6,0,0,4]:	negative-1 [14] by {a=>-a-1}
[2,4,0,4]:	transposed [14] {a=>2+8*a,b=>4+8*b,c=>4+8*c,d=>8*d} by [0,1,3,2]
...
[1,5,1,1]:	transposed [29] {a=>5+8*a,b=>1+8*b,c=>1+8*c,d=>1+8*d} by [1,0,2,3]
...
[1,5,5,5]:	transposed [32] {a=>5+8*a,b=>1+8*b,c=>5+8*c,d=>5+8*d} by [1,0,2,3]
