...
[2+8*x,2+8*y]: unknown, grown from [3]*1,2,1,2,4 x+2*x^2-3*y-12*y^2-16*y^3=0 -> [6]
...
solution [2,2],trivial(2)
[2+16*x,2+16*y]: unknown, grown from [6]*1,2,1,2,4, grown from [3]*1,4,1,4,16 x+4*x^2-3*y-24*y^2-64*y^3=0 -> [12]
...
solution [2,2],trivial(2)
[2+32*x,2+32*y]: unknown, grown from [12]*1,2,1,2,4, grown from [6]*1,4,1,4,16, grown from [3]*1,8,1,8,64 x+8*x^2-3*y-48*y^2-256*y^3=0 -> [24]
...
[11+32*x,5+32*y]: unknown, grown from [21]*1,2,1,2,4 22*x+32*x^2-75*y-480*y^2-1024*y^3=0 -> [42]
