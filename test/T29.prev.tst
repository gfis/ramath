...
[2+8*x,2+8*y]: unknown x+2*x^2-3*y-12*y^2-16*y^3=0 -> [6]
...
[13+16*x,5+16*y]: unknown 3+26*x+16*x^2-75*y-240*y^2-256*y^3=0 -> [19]
...
[11+16*x,5+16*y]: unknown 22*x+16*x^2-75*y-240*y^2-256*y^3=0 -> [21]
...
solution [2,2],trivial(2)
[2+32*x,2+32*y]: unknown x+8*x^2-3*y-48*y^2-256*y^3=0 -> [24]
...
[30+32*x,2+32*y]: unknown 7+15*x+8*x^2-3*y-48*y^2-256*y^3=0 -> [28]
...
[21+32*x,5+32*y]: unknown 10+42*x+32*x^2-75*y-480*y^2-1024*y^3=0 -> [37]
...
[11+32*x,5+32*y]: unknown 22*x+32*x^2-75*y-480*y^2-1024*y^3=0 -> [42]
