...
----------------
expanding queue[6]^4,meter=[1,2]: 448x+1472x²+2048x³+1024x⁴-160y-128y²
[2+4x,5+16y]:	unknown -> [8] [0,0] 448x+1472x²+2048x³+1024x⁴-320y-512y²
-> solution [2,5],NONTRIVIAL
expanding queue[7]^5,meter=[2,2]: 32x+320x²+1024x³+1024x⁴-32y-128y²
[1+8x,1+16y]:	same 64x+1280x²+8192x³+16384x⁴-64y-512y² map {x=>x/4,y=>y/8} -> [3] 16x+80x²+128x³+64x⁴-8y-8y²
-> solution [1,1],trivial(2)
[5+8x,9+16y]:	unknown -> [9] [1,1] 15680x+38144x²+40960x³+16384x⁴-576y-512y²+2240
