Expanding for base=2, reasons+features=base,evenexp,similiar,transpose igtriv,norm,invall,showfail
...
[1+2*a,1+2*b,1+2*c,1+2*d]:	unknown -> [1] -1+a+a^2+b+b^2-3*c-3*c^2-3*d-3*d^2
----------------
