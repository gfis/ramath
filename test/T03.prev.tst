Expanding for base=2, transposables={{a,b},{c,d}}, reasons+features=base,transpose,similiar igtriv,norm,invall,showfail
----------------
expanding queue[0]^-1: a^2 + b^2 - 3*c^2 - 3*d^2 = 0 meter=[2,2,2,2] *2
[0+2*a,0+2*b,0+2*c,0+2*d]: similiar to [0], same  a^2+b^2-3*c^2-3*d^2=0
