...
----------------
expanding queue[0]^-1,meter=[2,2]*2: -x³+y²+6
[1+2x,1+2y]:	unknown -> [1] 3x+6x²+4x³-2y-2y²-3
----------------
expanding queue[1]^0,meter=[2,1]*4: 3x+6x²+4x³-2y-2y²-3
[3+4x,1+2y]:	unknown -> [2] 27x+36x²+16x³-y-y²+5
----------------
expanding queue[2]^1,meter=[2,2]*8: 27x+36x²+16x³-y-y²+5
[7+8x,1+4y]:	unknown -> [3] 147x+168x²+64x³-y-2y²+42
[7+8x,3+4y]:	negative-1 [3] by {y=>-y-1}
----------------
expanding queue[3]^2,meter=[2,2]*16: 147x+168x²+64x³-y-2y²+42
