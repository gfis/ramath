...
[0+2*x,0+2*y,0+2*z]: similiar to  [0], affine map: {x=(2*x),y=(2*y),z=(2*z)}  16*x^4-16*y^4-4*z^2=0 success [0,0,0],trivial(3) success [2,2,0],trivial(3) 
...
[1+2*x,1+2*y,0+4*z]: similiar to  [1], affine map: {x=(1*x),y=(1*y),z=(2*z)}  8*x+24*x^2+32*x^3+16*x^4-8*y-24*y^2-32*y^3-16*y^4-16*z^2=0 success [1,1,0],trivial(3) success [3,3,0],trivial(3) 
[1+2*x,1+2*y,2+4*z]: failure constant=-4, vgcd=8

expanding queue[2]: 8*x + 24*x^2 + 32*x^3 + 16*x^4 - 16*y^4 - 4*z - 4*z^2 = 0 modulo [1,1,2] *4
[1+2*x,0+2*y,1+4*z]: similiar to  [2], affine map: {x=(1*x),y=(1*y),z=(2*z)}  8*x+24*x^2+32*x^3+16*x^4-16*y^4-8*z-16*z^2=0 success [1,0,1],trivial(3) 
...
[5+16*x,0+4*y,7+32*z]: similiar to  [5], affine map: {x=(2*x),y=(1*y),z=(2*z)}  576+8000*x+38400*x^2+81920*x^3+65536*x^4-256*y^4-448*z-1024*z^2=0
...
[1+16*x,2+4*y,7+32*z]: similiar to  [6], affine map: {x=(2*x),y=(1*y),z=(2*z)}  -64+64*x+1536*x^2+16384*x^3+65536*x^4-128*y-384*y^2-512*y^3-256*y^4-448*z-1024*z^2=0
...
[5+16*x,2+4*y,15+32*z]: similiar to  [7], affine map: {x=(2*x),y=(1*y),z=(2*z)}  384+8000*x+38400*x^2+81920*x^3+65536*x^4-128*y-384*y^2-512*y^3-256*y^4-960*z-1024*z^2=0
