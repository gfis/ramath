...
[3+8*x,0+4*y,7+16*z]: similiar to  [5], affine map: {x=(2*x),y=(2*y),z=(2*z)}  32+864*x+3456*x^2+6144*x^3+4096*x^4-256*y^4-224*z-256*z^2=0
...
[5+16*x,0+4*y,7+32*z]: similiar to  [6], affine map: {x=(2*x),y=(1*y),z=(2*z)}  576+8000*x+38400*x^2+81920*x^3+65536*x^4-256*y^4-448*z-1024*z^2=0
...
[1+16*x,2+4*y,7+32*z]: similiar to  [7], affine map: {x=(2*x),y=(1*y),z=(2*z)}  -64+64*x+1536*x^2+16384*x^3+65536*x^4-128*y-384*y^2-512*y^3-256*y^4-448*z-1024*z^2=0
...
[5+16*x,2+4*y,15+32*z]: similiar to  [9], affine map: {x=(2*x),y=(1*y),z=(2*z)}  384+8000*x+38400*x^2+81920*x^3+65536*x^4-128*y-384*y^2-512*y^3-256*y^4-960*z-1024*z^2=0
...
[7+16*x,0+4*y,15+32*z]: similiar to  [11], affine map: {x=(2*x),y=(1*y),z=(2*z)}  2176+21952*x+75264*x^2+114688*x^3+65536*x^4-256*y^4-960*z-1024*z^2=0
