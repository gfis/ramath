...
[1+2*x,1+2*y,0+4*z]: similiar to  [1], affine map: {x=(1*x),y=(1*y),z=(2*z)}  8*x+24*x^2+32*x^3+16*x^4-8*y-24*y^2-32*y^3-16*y^4-16*z^2=0
[1+2*x,1+2*y,2+4*z]: failure constant=-4, vgcd=8

expanding queue[2]: 8*x + 24*x^2 + 32*x^3 + 16*x^4 - 16*y^4 - 4*z - 4*z^2 = 0 modulo [1,1,2] *4
[1+2*x,0+2*y,1+4*z]: similiar to  [2], affine map: {x=(1*x),y=(1*y),z=(2*z)}  8*x+24*x^2+32*x^3+16*x^4-16*y^4-8*z-16*z^2=0
