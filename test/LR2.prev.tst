...
complete x, polyc= - 2*y + 4*z, rest=4 - 2*y^2 + 16*y*z - 23*z^2
...
complete y, polyc= - 4*z, rest=4 + 9*z^2
...
complete z, polyc=0, rest=4
--> bracket for z: 9*(z)
("4 + x^2 - 4*x*y + 2*y^2 + 8*x*z - 7*z^2").squareCompletion() = 4 + x^2 - 2*y^2 + 9*z^2
