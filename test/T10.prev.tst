...
expanding queue[1]^0: 2 + 4*x + 4*x^2 + 4*y + 4*y^2 - 10*z - 20*x*z - 20*y*z - 40*x*y*z + 4*z^2 = 0 meter=[2,2,2] *4
...
expanding queue[2]^0:  - 2 - 6*x + 4*x^2 - 6*y - 20*x*y + 4*y^2 - 6*z - 20*x*z - 20*y*z - 40*x*y*z + 4*z^2 = 0 meter=[2,2,2] *4
...
expanding queue[3]^1:  - 4 - 32*x + 16*x^2 - 32*y - 160*x*y + 16*y^2 - 4*z - 80*x*z - 80*y*z - 320*x*y*z + 16*z^2 = 0 meter=[1,1,2] *8
...
expanding queue[4]^1:  - 16 - 16*x + 16*x^2 - 112*y - 160*x*y + 16*y^2 - 44*z - 80*x*z - 240*y*z - 320*x*y*z + 16*z^2 = 0 meter=[1,1,2] *8
...
expanding queue[5]^1:  - 68 - 96*x + 16*x^2 - 96*y - 160*x*y + 16*y^2 - 164*z - 240*x*z - 240*y*z - 320*x*y*z + 16*z^2 = 0 meter=[1,1,2] *8
...
expanding queue[6]^2:  - 4 + 4*x + 16*x^2 - 52*y - 80*x*y + 16*y^2 - 52*z - 80*x*z - 240*y*z - 320*x*y*z + 16*z^2 = 0 meter=[2,2,2] *8
...
expanding queue[7]^3: 8 - 112*x + 16*x^2 - 112*y - 480*x*y + 16*y^2 + 56*z - 160*x*z - 160*y*z - 640*x*y*z + 64*z^2 = 0 meter=[2,2,2] *16
...
expanding queue[8]^5:  - 216 - 336*x + 16*x^2 - 336*y - 480*x*y + 16*y^2 - 264*z - 480*x*z - 480*y*z - 640*x*y*z + 64*z^2 = 0 meter=[2,2,2] *16
...
expanding queue[9]^6: 16 + 72*x + 64*x^2 - 264*y - 320*x*y + 64*y^2 - 264*z - 320*x*z - 2240*y*z - 2560*x*y*z + 64*z^2 = 0 meter=[2,2,2] *16
...
expanding queue[10]^6:  - 40 - 152*x + 64*x^2 - 40*y - 320*x*y + 64*y^2 - 584*z - 1600*x*z - 960*y*z - 2560*x*y*z + 64*z^2 = 0 meter=[2,2,2] *16
