...
ExponentGCDs=[1,1,1]
Expanding for base=2, reasons+features=base,transpose,same,similiar invall,norm
...
-> solution [0,0,0],trivial(3)
----------------
expanding queue[7]^6,meter=[2,2,2]: x²+y²-256x*y*z+z²
[0+256x,0+256y,0+256z]:	unknown -> [8] x²+y²-512x*y*z+z²
-> solution [0,0,0],trivial(3)
----------------
expanding queue[8]^7,meter=[2,2,2]: x²+y²-512x*y*z+z²
