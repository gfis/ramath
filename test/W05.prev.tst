...
<a title="manifest"    href="servlet?view=manifest">Manifest</a>, <a title="license"     href="servlet?view=license">License</a>, <a title="notice"      href="servlet?view=notice">References</a><br />
        ...
        <tr valign="top">
            <td colspan="2">Variable Substitutions<br />
                <table cellpadding="0" border="0">
...
<tr><td><input name="key2" type="hidden" value="c" />c-&gt;</td><td><input name="val2" size="20" maxsize="160" value="c" /></td></tr>
        ...
        <tr valign="top">
            <td align="left" colspan="2">RelationSet:<br />
                <textarea name="form1" wrap="virtual" cols="80" rows="4">(a%2Bb%2Bc)^6</textarea>
            </td>
        </tr>
        <tr valign="top">
...
<form action="servlet" method="get">
    ...
    <table cellpadding="0" border="0" width="640px">
        <tr valign="top">
            <td><span class="p1">1</span>a⁶ + <span class="p2">2</span>¹<span class="p3">3</span>a⁵*b + <span class="p3">3</span>¹<span class="p5">5</span>a⁴*b² + <span class="p2">2²</span><span class="p5">5</span>a³*b³ + <span class="p3">3</span>¹<span class="p5">5</span>a²*b⁴ + <span class="p2">2</span>¹<span class="p3">3</span>a*b⁵ + <span class="p1">1</span>b⁶ + <span class="p2">2</span>¹<span class="p3">3</span>a⁵*c + <span class="p2">2</span>¹<span class="p3">3</span>¹<span class="p5">5</span>a⁴*b*c + <span class="p2">2²</span><span class="p3">3</span>¹<span class="p5">5</span>a³*b²*c + <span class="p2">2²</span><span class="p3">3</span>¹<span class="p5">5</span>a²*b³*c + <span class="p2">2</span>¹<span class="p3">3</span>¹<span class="p5">5</span>a*b⁴*c + <span class="p2">2</span>¹<span class="p3">3</span>b⁵*c + <span class="p3">3</span>¹<span class="p5">5</span>a⁴*c² + <span class="p2">2²</span><span class="p3">3</span>¹<span class="p5">5</span>a³*b*c² + <span class="p2">2</span>¹<span class="p3">3²</span><span class="p5">5</span>a²*b²*c² + <span class="p2">2²</span><span class="p3">3</span>¹<span class="p5">5</span>a*b³*c² + <span class="p3">3</span>¹<span class="p5">5</span>b⁴*c² + <span class="p2">2²</span><span class="p5">5</span>a³*c³ + <span class="p2">2²</span><span class="p3">3</span>¹<span class="p5">5</span>a²*b*c³ + <span class="p2">2²</span><span class="p3">3</span>¹<span class="p5">5</span>a*b²*c³ + <span class="p2">2²</span><span class="p5">5</span>b³*c³ + <span class="p3">3</span>¹<span class="p5">5</span>a²*c⁴ + <span class="p2">2</span>¹<span class="p3">3</span>¹<span class="p5">5</span>a*b*c⁴ + <span class="p3">3</span>¹<span class="p5">5</span>b²*c⁴ + <span class="p2">2</span>¹<span class="p3">3</span>a*c⁵ + <span class="p2">2</span>¹<span class="p3">3</span>b*c⁵ + <span class="p1">1</span>c⁶</td>
        </tr>
        <tr valign="top">
            <td align="left">
