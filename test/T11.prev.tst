...
expanding queue[2]: 16*x^2 + 16*y^2 - 256*x*y*z + 16*z^2 = 0 modulo [2,2,2] *8
...
expanding queue[3]: 64*x^2 + 64*y^2 - 2048*x*y*z + 64*z^2 = 0 modulo [2,2,2] *16
...
expanding queue[4]: 256*x^2 + 256*y^2 - 16384*x*y*z + 256*z^2 = 0 modulo [2,2,2] *32
...
expanding queue[5]: 1024*x^2 + 1024*y^2 - 131072*x*y*z + 1024*z^2 = 0 modulo [2,2,2] *64
...
expanding queue[6]: 4096*x^2 + 4096*y^2 - 1048576*x*y*z + 4096*z^2 = 0 modulo [2,2,2] *128
...
expanding queue[7]: 16384*x^2 + 16384*y^2 - 8388608*x*y*z + 16384*z^2 = 0 modulo [2,2,2] *256
...
expanding queue[8]: 65536*x^2 + 65536*y^2 - 67108864*x*y*z + 65536*z^2 = 0 modulo [2,2,2] *512
