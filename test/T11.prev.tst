...
[0+2*x,0+2*y,0+2*z]: unknown 4*x^2+4*y^2-32*x*y*z+4*z^2=0 -> [1]
----------------
expanding queue[1]^0: 4*x^2 + 4*y^2 - 32*x*y*z + 4*z^2 = 0 meter=[2,2,2] *4
solution [0,0,0],trivial(3)
[0+4*x,0+4*y,0+4*z]: unknown 16*x^2+16*y^2-256*x*y*z+16*z^2=0 -> [2]
----------------
expanding queue[2]^1: 16*x^2 + 16*y^2 - 256*x*y*z + 16*z^2 = 0 meter=[2,2,2] *8
solution [0,0,0],trivial(3)
[0+8*x,0+8*y,0+8*z]: unknown 64*x^2+64*y^2-2048*x*y*z+64*z^2=0 -> [3]
----------------
expanding queue[3]^2: 64*x^2 + 64*y^2 - 2048*x*y*z + 64*z^2 = 0 meter=[2,2,2] *16
solution [0,0,0],trivial(3)
[0+16*x,0+16*y,0+16*z]: unknown 256*x^2+256*y^2-16384*x*y*z+256*z^2=0 -> [4]
----------------
expanding queue[4]^3: 256*x^2 + 256*y^2 - 16384*x*y*z + 256*z^2 = 0 meter=[2,2,2] *32
solution [0,0,0],trivial(3)
[0+32*x,0+32*y,0+32*z]: unknown 1024*x^2+1024*y^2-131072*x*y*z+1024*z^2=0 -> [5]
----------------
expanding queue[5]^4: 1024*x^2 + 1024*y^2 - 131072*x*y*z + 1024*z^2 = 0 meter=[2,2,2] *64
solution [0,0,0],trivial(3)
[0+64*x,0+64*y,0+64*z]: unknown 4096*x^2+4096*y^2-1048576*x*y*z+4096*z^2=0 -> [6]
----------------
expanding queue[6]^5: 4096*x^2 + 4096*y^2 - 1048576*x*y*z + 4096*z^2 = 0 meter=[2,2,2] *128
solution [0,0,0],trivial(3)
[0+128*x,0+128*y,0+128*z]: unknown 16384*x^2+16384*y^2-8388608*x*y*z+16384*z^2=0 -> [7]
----------------
expanding queue[7]^6: 16384*x^2 + 16384*y^2 - 8388608*x*y*z + 16384*z^2 = 0 meter=[2,2,2] *256
solution [0,0,0],trivial(3)
[0+256*x,0+256*y,0+256*z]: unknown 65536*x^2+65536*y^2-67108864*x*y*z+65536*z^2=0 -> [8]
----------------
expanding queue[8]^7: 65536*x^2 + 65536*y^2 - 67108864*x*y*z + 65536*z^2 = 0 meter=[2,2,2] *512
solution [0,0,0],trivial(3)
[0+512*x,0+512*y,0+512*z]: unknown 262144*x^2+262144*y^2-536870912*x*y*z+262144*z^2=0 -> [9]
