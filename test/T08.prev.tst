...
[3+4*a,0+2*b,0+2*c,3+4*d]: success [3,0,0,3],trivial(3) success [7,0,0,7],trivial(3)  108*a+144*a^2+64*a^3+8*b^3+8*c^3-108*d-144*d^2-64*d^3=0 -> [5]
...
[3+8*a,5+8*b,0+4*c,2+4*d]: success [3,5,4,6],NONTRIVIAL  144+216*a+576*a^2+512*a^3+600*b+960*b^2+512*b^3+64*c^3-48*d-96*d^2-64*d^3=0 -> [15]
...
[3+8*a,0+4*b,0+4*c,3+8*d]: similiar to  [5], affine map: {a=(2*a),b=(2*b),c=(2*c),d=(2*d)}  216*a+576*a^2+512*a^3+64*b^3+64*c^3-216*d-576*d^2-512*d^3=0 success [3,0,0,3],trivial(3) success [11,0,0,11],trivial(3) 
...
[7+8*a,0+4*b,0+4*c,7+8*d]: success [7,0,0,7],trivial(3) success [15,0,0,15],trivial(3)  1176*a+1344*a^2+512*a^3+64*b^3+64*c^3-1176*d-1344*d^2-512*d^3=0 -> [20]
...
[3+8*a,3+8*b,3+8*c,1+8*d]: similiar to  [7], affine map: {a=(2*a),b=(2*b),c=(2*c),d=(2*d)}  80+216*a+576*a^2+512*a^3+216*b+576*b^2+512*b^3+216*c+576*c^2+512*c^3-24*d-192*d^2-512*d^3=0
...
[1+8*a,1+8*b,1+8*c,3+8*d]: similiar to  [8], affine map: {a=(2*a),b=(2*b),c=(2*c),d=(2*d)}  -24+24*a+192*a^2+512*a^3+24*b+192*b^2+512*b^3+24*c+192*c^2+512*c^3-216*d-576*d^2-512*d^3=0
