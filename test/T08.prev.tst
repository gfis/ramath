...
[1+4*a,0+2*b,0+2*c,1+4*d]: grown from [2]*2,4,8,1,1,2,4,8 12*a+48*a^2+64*a^3+8*b^3+8*c^3-12*d-48*d^2-64*d^3=0
[3+4*a,0+2*b,0+2*c,3+4*d]: grown from [2]*18,12,8,1,1,18,12,8 108*a+144*a^2+64*a^3+8*b^3+8*c^3-108*d-144*d^2-64*d^3=0
