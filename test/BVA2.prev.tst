BigVectorArray.parseRecurrence("2*n*a(n) +(-23*n+36)*a(n-1) +6*(-2*n+3)*a(n-2)=0")
...
row 1	 dipows=[1,0]	 binoms=[1,2]	 result=[0,2]
bva[3]=2*n, vector=[0,2], poly=36*a_1 + 18*a_2 - 23*a_1*n - 12*a_2*n

shift by 0
row 0	 dipows=[1,0]	 binoms=[1,1]	 result=[36,0]
row 1	 dipows=[1,0]	 binoms=[1,2]	 result=[36,-23]
bva[2]=36 - 23*n, vector=[36,-23], poly=18*a_2 - 12*a_2*n

shift by 0
row 0	 dipows=[1,0]	 binoms=[1,1]	 result=[18,0]
row 1	 dipows=[1,0]	 binoms=[1,2]	 result=[18,-12]
