...
after2 y, pbody=15, ptail=5904
after3 y, phead=60*x^2 - 28*y^2, pbody=15
after  y, phead=60*x^2 - 28*y^2, pbody=15, ptail=5904, vmapt={x=>1+2*x,y=>15+4*y}
assertion:  - 21 + 15*x + 15*x^2 - 210*y - 28*y^2 !=  - 42 + 30*x + 30*x^2 - 105*y - 56*y^2
(" - 42 + 30*x + 30*x^2 - 105*y - 56*y^2").reduceIt() = 1476 + 15*x^2 - 7*y^2, vmapt={x=>1+2*x,y=>15+4*y}
