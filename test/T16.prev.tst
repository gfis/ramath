...
[1+4*a,0+4*b,1+4*c]: grown from [0] 8*a+16*a^2+16*b^2-8*c-16*c^2=0 success [1,0,1],trivial(3) success [5,0,5],trivial(3) 
...
[7+32*a,4+8*b,1+32*c]: grown from [0] 64+448*a+1024*a^2+64*b+64*b^2-64*c-1024*c^2=0
...
[3+32*a,4+8*b,5+32*c]: grown from [0] 192*a+1024*a^2+64*b+64*b^2-320*c-1024*c^2=0 success [3,4,5],NONTRIVIAL success [35,12,37],NONTRIVIAL 
...
[13+32*a,4+8*b,11+32*c]: grown from [0] 64+832*a+1024*a^2+64*b+64*b^2-704*c-1024*c^2=0
...
[9+32*a,4+8*b,15+32*c]: grown from [0] -128+576*a+1024*a^2+64*b+64*b^2-960*c-1024*c^2=0 success [9,12,15],NONTRIVIAL 
