...
[1+4*a,0+4*b,1+4*c]: grown from [1] 8*a+16*a^2+16*b^2-8*c-16*c^2=0 success [1,0,1],trivial(3) success [5,0,5],trivial(3) 
...
[3+16*a,4+8*b,5+16*c]: grown from [5] 96*a+256*a^2+64*b+64*b^2-160*c-256*c^2=0 success [3,4,5],NONTRIVIAL 
[11+16*a,4+8*b,5+16*c]: failure constant=112, vgcd=32
[3+16*a,0+8*b,13+16*c]: unknown -160+96*a+256*a^2+64*b^2-416*c-256*c^2=0 -> [12]
[11+16*a,0+8*b,13+16*c]: failure constant=-48, vgcd=32
[3+16*a,4+8*b,13+16*c]: failure constant=-144, vgcd=32
[11+16*a,4+8*b,13+16*c]: unknown -32+352*a+256*a^2+64*b+64*b^2-416*c-256*c^2=0 -> [13]

expanding queue[6]: 16 + 80*a + 64*a^2 + 16*b^2 - 48*c - 64*c^2 = 0 modulo [2,2,2] *16
[5+16*a,0+8*b,3+16*c]: failure constant=16, vgcd=32
[13+16*a,0+8*b,3+16*c]: unknown 160+416*a+256*a^2+64*b^2-96*c-256*c^2=0 -> [14]
[5+16*a,4+8*b,3+16*c]: unknown 32+160*a+256*a^2+64*b+64*b^2-96*c-256*c^2=0 -> [15]
[13+16*a,4+8*b,3+16*c]: failure constant=176, vgcd=32
[5+16*a,0+8*b,11+16*c]: unknown -96+160*a+256*a^2+64*b^2-352*c-256*c^2=0 -> [16]
[13+16*a,0+8*b,11+16*c]: failure constant=48, vgcd=32
[5+16*a,4+8*b,11+16*c]: failure constant=-80, vgcd=32
[13+16*a,4+8*b,11+16*c]: unknown 64+416*a+256*a^2+64*b+64*b^2-352*c-256*c^2=0 -> [17]

expanding queue[7]:  - 48 + 16*a + 64*a^2 + 16*b^2 - 112*c - 64*c^2 = 0 modulo [2,2,2] *16
[1+16*a,0+8*b,7+16*c]: failure constant=-48, vgcd=32
[9+16*a,0+8*b,7+16*c]: unknown 32+288*a+256*a^2+64*b^2-224*c-256*c^2=0 -> [18]
[1+16*a,4+8*b,7+16*c]: unknown -32+32*a+256*a^2+64*b+64*b^2-224*c-256*c^2=0 -> [19]
...
[9+16*a,4+8*b,15+16*c]: success [9,12,15],NONTRIVIAL  -128+288*a+256*a^2+64*b+64*b^2-480*c-256*c^2=0 -> [20]

expanding queue[8]: 64 + 224*a + 256*a^2 + 64*b + 64*b^2 - 32*c - 256*c^2 = 0 modulo [2,1,2] *32
[7+32*a,4+8*b,1+32*c]: grown from [8] 64+448*a+1024*a^2+64*b+64*b^2-64*c-1024*c^2=0
[23+32*a,4+8*b,1+32*c]: failure constant=544, vgcd=64
[7+32*a,4+8*b,17+32*c]: failure constant=-224, vgcd=64
[23+32*a,4+8*b,17+32*c]: unknown 256+1472*a+1024*a^2+64*b+64*b^2-1088*c-1024*c^2=0 -> [21]
...
[31+32*a,4+8*b,9+32*c]: unknown 896+1984*a+1024*a^2+64*b+64*b^2-576*c-1024*c^2=0 -> [24]
[15+32*a,4+8*b,25+32*c]: unknown -384+960*a+1024*a^2+64*b+64*b^2-1600*c-1024*c^2=0 -> [25]
...
[11+32*a,0+8*b,21+32*c]: unknown -320+704*a+1024*a^2+64*b^2-1344*c-1024*c^2=0 -> [26]
[27+32*a,0+8*b,21+32*c]: failure constant=288, vgcd=64

expanding queue[12]:  - 160 + 96*a + 256*a^2 + 64*b^2 - 416*c - 256*c^2 = 0 modulo [2,1,2] *32
[3+32*a,0+8*b,13+32*c]: failure constant=-160, vgcd=64
[19+32*a,0+8*b,13+32*c]: unknown 192+1216*a+1024*a^2+64*b^2-832*c-1024*c^2=0 -> [27]
[3+32*a,0+8*b,29+32*c]: unknown -832+192*a+1024*a^2+64*b^2-1856*c-1024*c^2=0 -> [28]
[19+32*a,0+8*b,29+32*c]: failure constant=-480, vgcd=64

expanding queue[13]:  - 32 + 352*a + 256*a^2 + 64*b + 64*b^2 - 416*c - 256*c^2 = 0 modulo [2,1,2] *32
[11+32*a,4+8*b,13+32*c]: failure constant=-32, vgcd=64
[27+32*a,4+8*b,13+32*c]: unknown 576+1728*a+1024*a^2+64*b+64*b^2-832*c-1024*c^2=0 -> [29]
[11+32*a,4+8*b,29+32*c]: unknown -704+704*a+1024*a^2+64*b+64*b^2-1856*c-1024*c^2=0 -> [30]
[27+32*a,4+8*b,29+32*c]: failure constant=-96, vgcd=64

expanding queue[14]: 160 + 416*a + 256*a^2 + 64*b^2 - 96*c - 256*c^2 = 0 modulo [2,1,2] *32
[13+32*a,0+8*b,3+32*c]: failure constant=160, vgcd=64
[29+32*a,0+8*b,3+32*c]: unknown 832+1856*a+1024*a^2+64*b^2-192*c-1024*c^2=0 -> [31]
[13+32*a,0+8*b,19+32*c]: unknown -192+832*a+1024*a^2+64*b^2-1216*c-1024*c^2=0 -> [32]
[29+32*a,0+8*b,19+32*c]: failure constant=480, vgcd=64

expanding queue[15]: 32 + 160*a + 256*a^2 + 64*b + 64*b^2 - 96*c - 256*c^2 = 0 modulo [2,1,2] *32
[5+32*a,4+8*b,3+32*c]: failure constant=32, vgcd=64
[21+32*a,4+8*b,3+32*c]: unknown 448+1344*a+1024*a^2+64*b+64*b^2-192*c-1024*c^2=0 -> [33]
[5+32*a,4+8*b,19+32*c]: unknown -320+320*a+1024*a^2+64*b+64*b^2-1216*c-1024*c^2=0 -> [34]
[21+32*a,4+8*b,19+32*c]: failure constant=96, vgcd=64

expanding queue[16]:  - 96 + 160*a + 256*a^2 + 64*b^2 - 352*c - 256*c^2 = 0 modulo [2,1,2] *32
[5+32*a,0+8*b,11+32*c]: failure constant=-96, vgcd=64
[21+32*a,0+8*b,11+32*c]: unknown 320+1344*a+1024*a^2+64*b^2-704*c-1024*c^2=0 -> [35]
...
expanding queue[17]: 64 + 416*a + 256*a^2 + 64*b + 64*b^2 - 352*c - 256*c^2 = 0 modulo [2,1,2] *32
[13+32*a,4+8*b,11+32*c]: grown from [17] 64+832*a+1024*a^2+64*b+64*b^2-704*c-1024*c^2=0
[29+32*a,4+8*b,11+32*c]: failure constant=736, vgcd=64
[13+32*a,4+8*b,27+32*c]: failure constant=-544, vgcd=64
[29+32*a,4+8*b,27+32*c]: unknown 128+1856*a+1024*a^2+64*b+64*b^2-1728*c-1024*c^2=0 -> [36]

expanding queue[18]: 32 + 288*a + 256*a^2 + 64*b^2 - 224*c - 256*c^2 = 0 modulo [2,1,2] *32
[9+32*a,0+8*b,7+32*c]: failure constant=32, vgcd=64
[25+32*a,0+8*b,7+32*c]: unknown 576+1600*a+1024*a^2+64*b^2-448*c-1024*c^2=0 -> [37]
[9+32*a,0+8*b,23+32*c]: unknown -448+576*a+1024*a^2+64*b^2-1472*c-1024*c^2=0 -> [38]
[25+32*a,0+8*b,23+32*c]: failure constant=96, vgcd=64

expanding queue[19]:  - 32 + 32*a + 256*a^2 + 64*b + 64*b^2 - 224*c - 256*c^2 = 0 modulo [2,1,2] *32
[1+32*a,4+8*b,7+32*c]: failure constant=-32, vgcd=64
[17+32*a,4+8*b,7+32*c]: unknown 256+1088*a+1024*a^2+64*b+64*b^2-448*c-1024*c^2=0 -> [39]
[1+32*a,4+8*b,23+32*c]: unknown -512+64*a+1024*a^2+64*b+64*b^2-1472*c-1024*c^2=0 -> [40]
[17+32*a,4+8*b,23+32*c]: failure constant=-224, vgcd=64

expanding queue[20]:  - 128 + 288*a + 256*a^2 + 64*b + 64*b^2 - 480*c - 256*c^2 = 0 modulo [2,1,2] *32
[9+32*a,4+8*b,15+32*c]: grown from [20] -128+576*a+1024*a^2+64*b+64*b^2-960*c-1024*c^2=0 success [9,12,15],NONTRIVIAL 
[25+32*a,4+8*b,15+32*c]: failure constant=416, vgcd=64
[9+32*a,4+8*b,31+32*c]: failure constant=-864, vgcd=64
[25+32*a,4+8*b,31+32*c]: unknown -320+1600*a+1024*a^2+64*b+64*b^2-1984*c-1024*c^2=0 -> [41]
Maximum level 4 reached, queue size = 42
