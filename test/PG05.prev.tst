...
for (m11 = -2; m11 < 3; m11++) /* row 1 */  {
for (m21 = -2; m21 < 3; m21++) /* row 2 */  {
for (m31 = -2; m31 < 3; m31++) /* row 3 */  {
if (0 + m11*m11 + m21*m21 - m31*m31 == 0) {
for (m13 = -2; m13 < 3; m13++) /* row 1 */  {
for (m23 = -2; m23 < 3; m23++) /* row 2 */  {
for (m33 = -2; m33 < 3; m33++) /* row 3 */  {
if (0 + m13*m13 + m23*m23 - m33*m33 == 0) {
for (m12 = -2; m12 < 3; m12++) /* row 1 */  {
for (m22 = -2; m22 < 3; m22++) /* row 2 */  {
for (m32 = -2; m32 < 3; m32++) /* row 3 */  {
...
[[2,2,0],[0,2,1],[2,2,1]]	 [4,3,5] [12,5,13] [24,7,25] [40,9,41] [60,11,61] [84,13,85] [112,15,113] [144,17,145] !!!!
 116  787 5765 test/PG05.this.tst
