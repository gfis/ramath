...
expanding queue[1]: 1 + 2*x + 2*x^2 - 3*y - 6*y^2 - 4*y^3 = 0 modulo [2,2] *4
...
expanding queue[2]:  - 6 + 2*x + 4*x^2 - 27*y - 36*y^2 - 16*y^3 = 0 modulo [2,2] *8
...
expanding queue[3]:  - 4 + 6*x + 4*x^2 - 27*y - 36*y^2 - 16*y^3 = 0 modulo [2,2] *8
...
expanding queue[4]:  - 3 + 2*x + 8*x^2 - 27*y - 72*y^2 - 64*y^3 = 0 modulo [2,2] *16
...
expanding queue[5]: 10*x + 8*x^2 - 27*y - 72*y^2 - 64*y^3 = 0 modulo [2,2] *16
...
expanding queue[6]:  - 2 + 6*x + 8*x^2 - 27*y - 72*y^2 - 64*y^3 = 0 modulo [2,2] *16
...
expanding queue[7]: 3 + 14*x + 8*x^2 - 27*y - 72*y^2 - 64*y^3 = 0 modulo [2,2] *16
...
expanding queue[8]:  - 83 + 2*x + 16*x^2 - 363*y - 528*y^2 - 256*y^3 = 0 modulo [2,2] *32
...
expanding queue[9]:  - 78 + 18*x + 16*x^2 - 363*y - 528*y^2 - 256*y^3 = 0 modulo [2,2] *32
...
expanding queue[10]: 10*x + 16*x^2 - 27*y - 144*y^2 - 256*y^3 = 0 modulo [2,2] *32
...
expanding queue[11]: 9 + 26*x + 16*x^2 - 27*y - 144*y^2 - 256*y^3 = 0 modulo [2,2] *32
...
expanding queue[12]:  - 1 + 6*x + 16*x^2 - 27*y - 144*y^2 - 256*y^3 = 0 modulo [2,2] *32
...
expanding queue[13]: 6 + 22*x + 16*x^2 - 27*y - 144*y^2 - 256*y^3 = 0 modulo [2,2] *32
...
expanding queue[14]:  - 80 + 14*x + 16*x^2 - 363*y - 528*y^2 - 256*y^3 = 0 modulo [2,2] *32
...
expanding queue[15]:  - 69 + 30*x + 16*x^2 - 363*y - 528*y^2 - 256*y^3 = 0 modulo [2,2] *32
...
expanding queue[16]:  - 615 + 2*x + 32*x^2 - 2187*y - 2592*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[17]:  - 606 + 34*x + 32*x^2 - 2187*y - 2592*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[18]:  - 39 + 18*x + 32*x^2 - 363*y - 1056*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[19]:  - 22 + 50*x + 32*x^2 - 363*y - 1056*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[20]: 10*x + 32*x^2 - 27*y - 288*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[21]: 13 + 42*x + 32*x^2 - 27*y - 288*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[22]:  - 209 + 26*x + 32*x^2 - 1083*y - 1824*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[23]:  - 188 + 58*x + 32*x^2 - 1083*y - 1824*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[24]:  - 214 + 6*x + 32*x^2 - 1083*y - 1824*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[25]:  - 203 + 38*x + 32*x^2 - 1083*y - 1824*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[26]: 3 + 22*x + 32*x^2 - 27*y - 288*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[27]: 22 + 54*x + 32*x^2 - 27*y - 288*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[28]:  - 40 + 14*x + 32*x^2 - 363*y - 1056*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[29]:  - 25 + 46*x + 32*x^2 - 363*y - 1056*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[30]:  - 608 + 30*x + 32*x^2 - 2187*y - 2592*y^2 - 1024*y^3 = 0 modulo [2,2] *64
...
expanding queue[31]:  - 585 + 62*x + 32*x^2 - 2187*y - 2592*y^2 - 1024*y^3 = 0 modulo [2,2] *64
