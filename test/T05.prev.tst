...
[0+2*x,0+2*y,0+2*z]: grown from [0]*16,16,4 16*x^4+16*y^4-4*z^2=0 success [0,0,0],trivial(3) 
...
[0+2*x,1+2*y,1+2*z]: transposition of [1] {0/0+2*y,0/1+2*x,2/1+2*z} by 0+2*y|0+2*x 1+2*x|1+2*y success [0,1,1],trivial(3) 
[1+2*x,1+2*y,1+2*z]: failure constant=1, vgcd=4

expanding queue[1]^0: 8*x + 24*x^2 + 32*x^3 + 16*x^4 + 16*y^4 - 4*z - 4*z^2 = 0 meter=[1,1,2] *4
[1+2*x,0+2*y,1+4*z]: grown from [1]*1,1,1,1,1,2,4 8*x+24*x^2+32*x^3+16*x^4+16*y^4-8*z-16*z^2=0 success [1,0,1],trivial(3) 
[1+2*x,0+2*y,3+4*z]: unknown -8+8*x+24*x^2+32*x^3+16*x^4+16*y^4-24*z-16*z^2=0 -> [2]

expanding queue[2]^1:  - 8 + 8*x + 24*x^2 + 32*x^3 + 16*x^4 + 16*y^4 - 24*z - 16*z^2 = 0 meter=[2,1,2] *8
...
expanding queue[3]^2:  - 48 + 16*x + 96*x^2 + 256*x^3 + 256*x^4 + 16*y^4 - 112*z - 64*z^2 = 0 meter=[2,2,2] *16
...
[1+8*x,0+4*y,15+16*z]: grown from [2]*28,4,16,64,256,16,20,16 -224+32*x+384*x^2+2048*x^3+4096*x^4+256*y^4-480*z-256*z^2=0
...
expanding queue[4]^2: 32 + 432*x + 864*x^2 + 768*x^3 + 256*x^4 + 16*y^4 - 112*z - 64*z^2 = 0 meter=[2,2,2] *16
[3+8*x,0+4*y,7+16*z]: grown from [4]*1,2,4,8,16,16,2,4 32+864*x+3456*x^2+6144*x^3+4096*x^4+256*y^4-224*z-256*z^2=0
...
expanding queue[5]^3: 576 + 4000*x + 9600*x^2 + 10240*x^3 + 4096*x^4 + 256*y^4 - 224*z - 256*z^2 = 0 meter=[2,1,2] *32
[5+16*x,0+4*y,7+32*z]: grown from [5]*1,2,4,8,16,1,2,4 576+8000*x+38400*x^2+81920*x^3+65536*x^4+256*y^4-448*z-1024*z^2=0
...
expanding queue[6]^3:  - 32 + 32*x + 384*x^2 + 2048*x^3 + 4096*x^4 + 128*y + 384*y^2 + 512*y^3 + 256*y^4 - 224*z - 256*z^2 = 0 meter=[2,1,2] *32
...
expanding queue[7]^3: 416 + 4000*x + 9600*x^2 + 10240*x^3 + 4096*x^4 + 128*y + 384*y^2 + 512*y^3 + 256*y^4 - 480*z - 256*z^2 = 0 meter=[2,1,2] *32
...
expanding queue[8]^4: 2368 + 10976*x + 18816*x^2 + 14336*x^3 + 4096*x^4 + 128*y + 384*y^2 + 512*y^3 + 256*y^4 - 224*z - 256*z^2 = 0 meter=[2,1,2] *32
[7+16*x,2+4*y,7+32*z]: grown from [8]*1,2,4,8,16,1,1,1,1,2,4 2368+21952*x+75264*x^2+114688*x^3+65536*x^4+128*y+384*y^2+512*y^3+256*y^4-448*z-1024*z^2=0
...
expanding queue[9]^4: 2176 + 10976*x + 18816*x^2 + 14336*x^3 + 4096*x^4 + 256*y^4 - 480*z - 256*z^2 = 0 meter=[2,1,2] *32
[7+16*x,0+4*y,15+32*z]: grown from [9]*1,2,4,8,16,1,2,4 2176+21952*x+75264*x^2+114688*x^3+65536*x^4+256*y^4-960*z-1024*z^2=0
...
expanding queue[10]^4:  - 128 + 864*x + 3456*x^2 + 6144*x^3 + 4096*x^4 + 128*y + 384*y^2 + 512*y^3 + 256*y^4 - 480*z - 256*z^2 = 0 meter=[2,1,2] *32
[3+16*x,2+4*y,15+32*z]: grown from [10]*1,2,4,8,16,1,1,1,1,2,4 -128+1728*x+13824*x^2+49152*x^3+65536*x^4+128*y+384*y^2+512*y^3+256*y^4-960*z-1024*z^2=0
