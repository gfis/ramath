...
solution [0,1],trivial(1)
[0+4x,1+8y]:	unknown -> [6] -64x^2+1024x^4-32y-128y^2
[2+4x,5+8y]:	unknown -> [7] 448x+1472x^2+2048x^3+1024x^4-160y-128y^2
expanding queue[5]^3,meter=[2,2]*16: 16x+80x^2+128x^3+64x^4-16y-32y^2
solution [1,1],trivial(2)
[1+4x,1+8y]:	unknown -> [8] 32x+320x^2+1024x^3+1024x^4-32y-128y^2
[3+4x,1+8y]:	negative-1 [8] by {x=>-x-1}
----------------
expanding queue[6]^4,meter=[1,2]*32: -64x^2+1024x^4-32y-128y^2
solution [0,1],trivial(1)
[0+4x,1+16y]:	unknown -> [9] -64x^2+1024x^4-64y-512y^2
expanding queue[7]^4,meter=[1,2]*32: 448x+1472x^2+2048x^3+1024x^4-160y-128y^2
solution [2,5],NONTRIVIAL
[2+4x,5+16y]:	unknown -> [10] 448x+1472x^2+2048x^3+1024x^4-320y-512y^2
expanding queue[8]^5,meter=[2,2]*32: 32x+320x^2+1024x^3+1024x^4-32y-128y^2
solution [1,1],trivial(2)
