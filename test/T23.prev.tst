...
[1+4*a,0+2*b,1+4*c]: similiar to  [2], affine map: {a=(2*a),b=(1*b),c=(2*c)}  20*a+160*a^2+640*a^3+1280*a^4+1024*a^5+32*b^5-20*c-160*c^2-640*c^3-1280*c^4-1024*c^5=0 success [1,0,1],trivial(3) success [5,0,5],trivial(3) 
...
[3+8*a,0+2*b,3+8*c]: similiar to  [4], affine map: {a=(2*a),b=(1*b),c=(2*c)}  3240*a+17280*a^2+46080*a^3+61440*a^4+32768*a^5+32*b^5-3240*c-17280*c^2-46080*c^3-61440*c^4-32768*c^5=0 success [3,0,3],trivial(3) success [11,0,11],trivial(3) 
